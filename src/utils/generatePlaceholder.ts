...
const PLACEHOLDER_QUALITY = parseInt(process.env.IMAGE_PLACEHOLDER_QUALITY || '30');
 ...
 */
export async function generatePlaceholder(input: string | Buffer): Promise<string | null> {
  try {
    let buffer: Buffer;
